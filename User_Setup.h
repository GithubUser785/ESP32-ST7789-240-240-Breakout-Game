...
// For ESP32 Dev board (ST7789 display setup)

// Define your pins here
#define TFT_MISO -1    // Not used
#define TFT_MOSI 23    // Data pin (SDA)
#define TFT_SCLK 18    // Clock pin (SCL)
#define TFT_CS   -1    // Not used, or set to your specific pin if required
...
//#define TFT_WR -1    // Write strobe for modified Raspberry Pi TFT only
